    ...
    <header className="site-header">
      <div className="topbar">
        <div className="container topbar-inner">
          <div className="topbar-social">
            <a href="https://instagram.com/inbarsk" target="_blank" rel="noreferrer" aria-label="Instagram">
            ...
            <a href="https://facebook.com/inbarsk" target="_blank" rel="noreferrer" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
      ...
      <div className="header-inner container">
        <nav className="header-nav header-nav--left">
          <Link href="/category/drinking">Drinking</Link>
        ...
        <div className="header-nav header-nav--right">
          <button className="header-search-btn" aria-label="Hľadať">
